...
export default function Header() {
  ...
  return (
    <header className="hRDUUh">
      <div className="sc-iGPElx gCinre">
        <div className="sc-kasBVs gbkTzy">
          <div className="sc-hgHYgh gqxEJg">
            <div className="sc-kaNhvL Iocjv">
              <div className="sc-fgfRvd cDCrOG">
                <div className="sc-iBEsjs jkAnwO">
                  <a className="sc-hzNEM jXeoeh">
                    <svg
                      viewBox="0 0 88 26"
                      height="33.9"
                      width="115"
                ...
                <div id="1" className="sc-kxynE gLkGwh">
                  <div id="2" className="sc-jTzLTM sc-chbbiW hPUYXB">
                    <span id="3" className="sc-cooIXK hKlNgb">
                      <svg
                        viewBox="0 0 12 12"
                        xmlns="http://www.w3.org/2000/svg"
                      >
                    ...
                    <span id="4" className="sc-fcdeBU cNeUMt">
                      Search for Movies, Events, Plays, Sports and Activities
                    </span>
                  </div>
                </div>
              </div>
              <div className="sc-hIVACf HlTzY">
                <div className="sc-gmeYpB jVkKUA">
                  <span className="sc-kZmsYB ekDEWP ellipsis" onClick={()=>navigate('/')} >Chennai</span>
                </div>
                <div className="sc-gmeYpB jVkKUA">
                  <div className="sc-fQejPQ jWuMjc">Sign in</div>
                  <div className="sc-fZwumE dieEul">
                    <svg
                      width="22px"
                      height="14px"
                      xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="sc-LKuAh cOjdvG">
        <div className="sc-jXQZqI iuZyni">
          <div className="sc-kasBVs gbkTzy">
            <div className="sc-hgHYgh gqxEJg">
              <div className="sc-fgfRvd cDCrOG">
                <div className="sc-drMfKT jRmBja">
                  <a href="/allMovies" className="sc-eKZiaR caGbXw">
                    Movies
                  </a>
                  <a href="/explore/c/stream" className="sc-eKZiaR caGbXw">
                    Stream<div className="sc-gVyKpa ebdoCp">NEW</div>
                  </a>
                  <a href="/explore/events-chennai" className="sc-eKZiaR caGbXw">
                    Events
                  </a>
                  <a href="/explore/plays-chennai" className="sc-eKZiaR caGbXw">
                    Plays
                  </a>
                  <a href="/explore/sports-chennai" className="sc-eKZiaR caGbXw">
                    Sports
                  </a>
                  <a
                    href="/explore/activities-chennai"
                    className="sc-eKZiaR caGbXw"
                  >
                    Activities
                  </a>
                  <a href="/buzz" className="sc-eKZiaR caGbXw">
                    Buzz
                  </a>
                  <a href="/movies" className="sc-eKZiaR caGbXw">
                    Add Movies
                  </a>
                </div>
              </div>
              <div className="sc-hIVACf HlTzY">
                <div className="sc-drMfKT jRmBja">
                  <a href="/list-your-show/" className="sc-gpHHfC gqtJRe">
                    ListYourShow
                  </a>
                  <a href="/voucher" className="sc-gpHHfC gqtJRe">
                    Corporates
                  </a>
                  <a href="/offers" className="sc-gpHHfC gqtJRe">
                    Offers
                  </a>
                  <a href="/giftcards" className="sc-gpHHfC gqtJRe">
                    Gift Cards
                  </a>
                </div>
              </div>
